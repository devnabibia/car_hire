...
import { status_data } from "../Filters";
import Filter from "../Filters";
import PaginationFooter from "../PaginationFooter";
import UserRaw from "../SystemUsers/UserRaw";
          ...
          <div className="flex flex-col overflow-auto ">
            <div className=" shadow-md  rounded-t-md  overflow-auto  w-full    ">
              <div className="flex flex-row gap-4 items-center justify-between  py-8  w-full  ">
                ...
                <div className="flex w-full flex-row gap-2 md:max-w-[6rem]  justify-end ">
                  <Filter
            ...
            {data && data?.data[0].data.length > 0 ? (
              <div className="overflow-x-scroll border pb-12 ">
                <table className="w-full text-sm text-left  text-gray-600 ">
                  <thead className="text-xs  font-medium text-gray-900 whitespace-nowrap uppercase bg-primary/30 ">
                    <tr>
