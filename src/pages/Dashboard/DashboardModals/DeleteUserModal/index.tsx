...
import { useRemoveUserByIdMutation } from "../../../../features/api/apiSlice";
import toast from "react-hot-toast";
import { Spinner } from "../../../../components/Loaders";

const DeleteUserModal = ({ toggleModal, client_name, user_id }: any) => {
  const [removeUser, { isSuccess, error, isLoading }] =
    useRemoveUserByIdMutation(user_id);
          ...
          <div className="relative  z-40 p-4 text-center bg-white rounded-lg max-w-lg  mx-auto shadow  sm:p-5">
            ...
            <div className=" bg-red-50 text-red-800 rounded-md mb-4 px-2 py-6">
              ...
              <p className="text-start mt-2">
                By deleting this user, listings associated will also be
                permanently deleted.
              </p>
            </div>
